...
def go(args):
    ...
    model_artifact = wandb.Artifact(name=args.output_artifact,
                           type="model_export",  description="inference pipeline", metadata=rf_config)
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    non_ordinal_categorical_preproc = Pipeline(steps=[('SimpleImputer', SimpleImputer(strategy="most_frequent")),
